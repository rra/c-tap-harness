=for stopwords
ok okv const printf-style Allbery
...
void B<ok>(int I<success>, const char *I<format>, ...);

void B<okv>(int I<success>, const char *I<format>, va_list I<args>);

void B<ok_block>(unsigned long I<count>, int I<success>, const char *I<format>, ...);
